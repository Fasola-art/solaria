---
name: gws-gmail-read
description: "Gmail: Read a message and extract its body or headers. Use when the user asks to inspect a specific email, summarize message contents, check sender/date/subject, or extract email body text."
metadata:
  version: 0.22.5
  openclaw:
