---
name: gws-tasks
description: "Google Tasks: Manage task lists and tasks. Use when the user asks to create, list, update, complete, organize, or convert work items into Google Tasks."
metadata:
  version: 0.22.5
  openclaw:
