...
- [Phase 1 — Build a feedback loop](#phase-1-build-a-feedback-loop)
  - [Ways to construct one — try them in roughly this order](#ways-to-construct-one-try-them-in-roughly-this-order)
  - [Iterate on the loop itself](#iterate-on-the-loop-itself)
...
<!-- Imported reference. Source: /tmp/matt-skills-import/skills/engineering/diagnose/SKILL.md -->
