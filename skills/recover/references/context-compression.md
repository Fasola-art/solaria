...
- [Detailed Topics](#detailed-topics)
  - [Optimize for Tokens-Per-Task, Not Tokens-Per-Request](#optimize-for-tokens-per-task-not-tokens-per-request)
  - [Solve the Artifact Trail Problem First](#solve-the-artifact-trail-problem-first)
  - [Structure Summaries with Mandatory Sections](#structure-summaries-with-mandatory-sections)
- [Session Intent](#session-intent)
- [Files Modified](#files-modified)
- [Decisions Made](#decisions-made)
- [Current State](#current-state)
- [Next Steps](#next-steps)
  - [Choose Compression Triggers Strategically](#choose-compression-triggers-strategically)
  - [Evaluate Compression with Probes, Not Metrics](#evaluate-compression-with-probes-not-metrics)
  - [Score Compression Across Six Dimensions](#score-compression-across-six-dimensions)
- [Practical Guidance](#practical-guidance)
  - [Apply the Three-Phase Compression Workflow for Large Codebases](#apply-the-three-phase-compression-workflow-for-large-codebases)
  - [Use Example Artifacts as Compression Seeds](#use-example-artifacts-as-compression-seeds)
  - [Implement Anchored Iterative Summarization Step by Step](#implement-anchored-iterative-summarization-step-by-step)
  - [Select the Right Approach for the Session Profile](#select-the-right-approach-for-the-session-profile)
  - [Calibrate Compression Ratios by Method](#calibrate-compression-ratios-by-method)
- [Examples](#examples)
- [Session Intent](#session-intent)
...
<!-- Imported reference. Source: /tmp/context-skills-import/skills/context-compression/SKILL.md -->
