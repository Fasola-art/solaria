...
description: "Google Calendar: Show upcoming events across all calendars. Use when the user asks for today's schedule, upcoming meetings, agenda summaries, availability context, or calendar-based briefing."
metadata:
  version: 0.22.5
  openclaw:
