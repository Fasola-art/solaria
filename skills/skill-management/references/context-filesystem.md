...
- [Detailed Topics](#detailed-topics)
  - [The Static vs Dynamic Context Trade-off](#the-static-vs-dynamic-context-trade-off)
  - [Pattern 1: Filesystem as Scratch Pad](#pattern-1-filesystem-as-scratch-pad)
  - [Pattern 2: Plan Persistence](#pattern-2-plan-persistence)
  - [Pattern 3: Sub-Agent Communication via Filesystem](#pattern-3-sub-agent-communication-via-filesystem)
  - [Pattern 4: Dynamic Skill Loading](#pattern-4-dynamic-skill-loading)
  - [Pattern 5: Terminal and Log Persistence](#pattern-5-terminal-and-log-persistence)
  - [Pattern 6: Learning Through Self-Modification](#pattern-6-learning-through-self-modification)
  - [Filesystem Search Techniques](#filesystem-search-techniques)
- [Practical Guidance](#practical-guidance)
  - [When to Use Filesystem Context](#when-to-use-filesystem-context)
...
<!-- Imported reference. Source: /tmp/context-skills-import/skills/filesystem-context/SKILL.md -->
