...
### Agent Tool Design Reference
- Read `references/context-tool-design.md` when designing agent-facing tool descriptions, schemas, response formats, error recovery messages, or MCP tool catalog consolidation.
