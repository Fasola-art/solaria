...
- [Detailed Topics](#detailed-topics)
  - [The Tool-Agent Interface](#the-tool-agent-interface)
  - [The Consolidation Principle](#the-consolidation-principle)
  - [Architectural Reduction](#architectural-reduction)
  - [Tool Description Engineering](#tool-description-engineering)
  ...
  - [Tool Collection Design](#tool-collection-design)
  - [MCP Tool Naming Requirements](#mcp-tool-naming-requirements)
  - [Using Agents to Optimize Tools](#using-agents-to-optimize-tools)
  - [Testing Tool Design](#testing-tool-design)
- [Practical Guidance](#practical-guidance)
  - [Tool Selection Framework](#tool-selection-framework)
  - [Tool Audit Checklist](#tool-audit-checklist)
- [Examples](#examples)
...
<!-- Imported reference. Source: /tmp/context-skills-import/skills/tool-design/SKILL.md -->
