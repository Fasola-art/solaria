...
description: "Google Sheets: Append a row to a spreadsheet. Use when the user asks to log data, add a record, save form-like output, or append structured values into an existing Google Sheet."
metadata:
  version: 0.22.5
  openclaw:
