---
name: gws-drive
description: "Google Drive: Manage files, folders, and shared drives. Use when the user asks to find, list, create, move, inspect, organize, or share files and folders in Google Drive."
metadata:
  version: 0.22.5
  openclaw:
