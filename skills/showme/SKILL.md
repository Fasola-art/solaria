---
name: showme
description: Visual mockup and annotation tool for Codex. Use when the user invokes /showme or wants to create, inspect, or act on coordinate-tracked visual mockups and annotated pages.
---

# ShowMe - Visual Mockup & Annotation Tool for Codex

ShowMe lets you create visual mockups with coordinate-tracked annotations across multiple pages. Draw, annotate, and provide component-specific feedback that Codex can see and act on.
...
```bash
bun run ~/workspace/projects/ShowMe/server/index.ts
```
...
6. Click "Send to Codex" when done
