...
description: "Google Calendar: Create a new event. Use when the user asks to schedule a meeting, add a calendar event, set time/title/attendees/location, or create a dated reminder on Google Calendar."
metadata:
  version: 0.22.5
  openclaw:
